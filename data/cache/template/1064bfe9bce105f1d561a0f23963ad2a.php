<?php if (!defined('HAMSTER_PATH')) exit(); /*a:6:{s:67:"D:\phpwork\xima-union-admin\core\app\admin\views\setting/index.html";i:1616133411;s:59:"D:\phpwork\xima-union-admin\core\app\admin\views\title.html";i:1618246595;s:59:"D:\phpwork\xima-union-admin\core\app\admin\views\asset.html";i:1616306538;s:61:"D:\phpwork\xima-union-admin\core\app\admin\views\sidebar.html";i:1618247582;s:60:"D:\phpwork\xima-union-admin\core\app\admin\views\navbar.html";i:1618247311;s:60:"D:\phpwork\xima-union-admin\core\app\admin\views\script.html";i:1615978259;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8"/>
                                    ...
                                    <div class="table-content">
                                        <table class="table table-hover table-condensed">
                                            ...
                                            <tr>
                                                <th style="width: 100px;">
                                                    <label class="checkbox-primary">
                                                        <input name="ids[]" value="<?php echo $item['web_id']; ?>" class="sub-checkbox" type="checkbox">
                                                        <span></span>
                                                    </label>
                                                </th>
                                                <td><?php echo $item['web_domain']; ?></td>
                                                <td><?php echo $item['web_name']; ?></td>
                                                <td><?php echo $item['web_tpl']; ?></td>
                                                <td>
                                                    <label class="switch switch-sm switch-primary">
                                                        <input onchange="enableChange(<?php echo $item['web_id']; ?>, <?php echo $item['web_enable']; ?>)" <?php echo $item['web_enable'] ? 'checked' : ''; ?> type="checkbox">
                                                        <span></span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <div class="table-cell">
                                                        <a title="编辑" class="btn btn-xs "
                                                           href="?do=<?php echo CURRENT_CONTROLLER; ?>.add&id=<?php echo $item['web_id']; ?>"
                                                           data-toggle="tooltip" data-placement="top">
                                                            <i class="fa fa-fw fa-edit"></i>编辑
                                                        </a>
                                                        <a title="进入管理" class="btn btn-xs "
                                                           href="?do=list.index&wid=<?php echo $item['web_id']; ?>"
                                                           data-toggle="tooltip" data-placement="top">
                                                            <i class="fa fa-fw fa-edit"></i>进入管理
                                                        </a>
                                                        <a title="删除" class="btn btn-xs confirm"
                                                           href="?do=<?php echo CURRENT_CONTROLLER; ?>.delete&id=<?php echo $item['web_id']; ?>"
                                                           data-toggle="tooltip" data-placement="top">
